...
- [ ] Реализовать drag-n-drop для загружаемого файла (**+10**)
- [ ] Реализовать drag-n-drop-сортировку списка прикрепленных файлов (можно менять их порядок в общем блоке)(**+10**)
- [ ] Реализовать имитацию загрузки файлов (кастомный лоадер на несколько секунд) (**+10**)
- [ ] Аккуратный оформленный дизайн, анимации (не учитываем субъективность вкусов) (**+5**)
