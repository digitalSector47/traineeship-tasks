...
Десктоп отображается от `1280px` и выше. Контейнер имеет фиксированную ширину и центрируется. Планшет отображается в промежутке `768px` - `1279px`, `767px` и ниже - отображаем мобильную версию.
...
- [ ] Реализовать подсветку инпутов формы на CSS по событию `blur` (**+20**)
