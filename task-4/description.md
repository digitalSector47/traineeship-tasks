...
&emsp;&emsp;Главной задачей данного этапа является ознакомление с API библиотеки React, соответственно, в вашем распоряжении будут находиться по большей части только ее возможности и, конечно, все возможности браузерного окружения, 
...
13.	Писать коммиты по правилам "Соглашения о коммитах" - https://www.conventionalcommits.org/en/v1.0.0/
...
* Коммиты оформлены не по правилам "Соглашения о коммитах" **-10**
